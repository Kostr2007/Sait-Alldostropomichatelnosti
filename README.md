...
- [ ] Сделать кнопки показывающи за счёт закругление(например если закругление только справа, переход, слева? Назад! Сверху? Из интернета и так далее!)... что сайт переходит на другую страницу или активирует что то в этой страницу! И добавить анимацию при нажатии!
...
- [ ] Вынести в README категорию обновления в другой .md файле и ссылаться на него! Чтобы лицо RADME было чище!
