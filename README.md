...
![Version](https://img.shields.io/badge/version-0.27.30-blue?style=for-the-badge)
...
- [ ] Разобраться с проблемой в мобильной приложений с прокрутокой (так как там отступ).
- [ ] Почистить классы в `header.astro`.
