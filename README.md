...
- Не изменяйте файл `README.md`! Для этого есть `CHANGELOG.md` а если вам нужно добавить что то в `README.md` то создайте отдельный файл и ссылаться на него! Например `DOCUMENTATION-DESIGN.md` для дизайна и так далее! Чтобы лицо RADME было чище!
