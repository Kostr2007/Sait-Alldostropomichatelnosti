...
В этом сайте будет использовать чётные числа... тоесть не px-6 px-3 ❌. А px-6 px-2 ✔. А цветовая палитра будет от GNOME! Либо бери из приложения Pallete или этот сайт![https://developer.gnome.org/hig/reference/palette.html]
