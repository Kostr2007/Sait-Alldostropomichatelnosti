...
- [ ] Исправить ошибку со границами. (Проблема: Нельзя редактировать цвет в themes. Но при смене темы он меняет цвет! И почему смена тема... привязан цвет границ... на цвет **ТЕКСТА**)
